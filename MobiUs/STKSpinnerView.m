...
@property (nonatomic, assign) CALayer *labelLayer;
...
- (void)_commonInit
{
    ...
    [self setLabelLayer:l];
    _label.text = @"hi";
    _label.backgroundColor = [UIColor redColor];
    [l setContents:_label];
    
    CALayer *m = [CALayer layer];
    [[self labelLayer] setMask:m];
    [self setMaskLayer:m];
    ...
    [s setStrokeColor:[[UIColor orangeColor] CGColor]];
...
- (void)layoutSubviews
{
    ...
    [[self labelLayer] setFrame:bounds];
